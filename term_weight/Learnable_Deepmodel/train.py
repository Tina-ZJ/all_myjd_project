...
tf.app.flags.DEFINE_string("output_dir","./output_v2_sku3_cid3/checkpoint",'save model path')
...
command = "hadoop fs -ls hdfs://ns1013/user/recsys/suggest/app.db/qp_common_file/sku_tw/2022-03-12/v3_cid3/ | grep part | awk '{print $NF}' 2>/dev/null"
