...
def inference(ctfigm_model, bert_model, input_mask):
...
def serving_input_receiver_fn():
    input_len = FLAGS.num_terms * (FLAGS.local_f_len + FLAGS.global_f_len)
    input_features = tf.placeholder(dtype=tf.float32, shape=[1, input_len], name='input_features')
    ...
    receiver_tensors = {'input_features': input_features,
                        'input_ids': input_ids,
                        'input_mask': input_mask,
                        'segment_ids': segment_ids}
    features = {'input_features': input_features,
                        'input_ids': input_ids,
                        'input_mask': input_mask,
                        'segment_ids': segment_ids}
