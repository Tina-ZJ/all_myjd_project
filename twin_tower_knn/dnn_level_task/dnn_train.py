            ...
            for epoch in range(curr_epoch,FLAGS.num_epochs):
                ...
                while train_example_num < train_sample_num:
                    try :
                        ...
                        query, cid, cid_neg, cid3, cid3_neg, product, product_neg = train_batch_data
                        if len(query)!=FLAGS.batch_size:
                            continue
                        feed_dict = {model.query: query, model.cid: cid, model.cid3: cid3, model.product: product, model.cid_neg: cid_neg, model.cid3_neg: cid3_neg, model.product_neg: product_neg,  model.dropout_keep_prob: 0.5}
