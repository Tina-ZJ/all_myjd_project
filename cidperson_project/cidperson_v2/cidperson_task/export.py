...
SIGNATURE_NAME='cid_personalization_bert'    #cid_personalization_bert  serving_default
...
tf.app.flags.DEFINE_string("term_path","data/term_index_8_25.txt",'path of term')
tf.app.flags.DEFINE_string("cidx_path","data/cidx_index_6_12.txt",'path of cid')
...
tf.app.flags.DEFINE_string("output_dir","./output_1L_relu_32/checkpoint",'save model path')
