...
tf.app.flags.DEFINE_float("drop_prob",0.5,"drop_prob")  
tf.app.flags.DEFINE_float("lr",0.001,"learning rate") 
tf.app.flags.DEFINE_integer("batch_size", 512, "Batch size for training/evaluating.")
tf.app.flags.DEFINE_integer("decay_steps", 32000, "how many steps before decay learning rate.")
tf.app.flags.DEFINE_float("decay_rate", 0.95, "Rate of decay for learning rate.")
tf.app.flags.DEFINE_integer("seq_len",35,"max sentence length")
...
tf.app.flags.DEFINE_integer("dev_sample_num",50000000,"dev sample num")
...
tf.app.flags.DEFINE_string("train_path", None, 'train data path')


command = "hadoop fs -ls %s | grep part | awk '{print $NF}' 2>/dev/null" % (FLAGS.train_path)
