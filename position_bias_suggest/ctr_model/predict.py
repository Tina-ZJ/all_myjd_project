...
tf.app.flags.DEFINE_string("save_file","./data/test_top.predict_large",'path of test file')
tf.app.flags.DEFINE_string("ckpt_dir","output_large/checkpoint","checkpoint location for the model")
