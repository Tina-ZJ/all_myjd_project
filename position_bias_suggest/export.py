...
tf.app.flags.DEFINE_string("output_dir","./output_03.11_large/checkpoint",'save model path')
...
command = "hadoop fs -ls hdfs://ns1013/user/recsys/suggest/app.db/qp_common_file/suggest_rank/2022-01-14/bert/v5/ | grep part | awk '{print $NF}' 2>/dev/null"
