...
command = "hadoop fs -ls hdfs://ns1013/user/recsys/suggest/app.db/qp_common_file/suggest_rank/model_preprocess/2022-03-28/bert/process_v1/ | grep part | awk '{print $NF}' 2>/dev/null"
...
def model_fn_builder(init_checkpoint, term_size, bert_config):
    def model_fn(features, labels, mode, params):
        ...
        srch_kwd_seg_id_long = features["srch_kwd_seg_id_long"]
        ...
        model = modeling.BertModel(
                ...
                srch_kwd_seg_id_long=srch_kwd_seg_id_long,
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            # lambda rank
            loss, num_pairs, train_op = lambda_rank(score, relative_label, position, group_id, FLAGS.sigma, FLAGS.lr ) 
...
def file_based_input_fn_builder(num_cpu_threads, input_file, batch_size, seq_len, is_training, drop_remainder):
    name_to_features = {
        ...
        'srch_kwd_seg_id_long': tf.FixedLenFeature([100], tf.int64),
