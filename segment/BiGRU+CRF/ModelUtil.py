...
def extract_parameter(modelPath):
    ...
    out_f = file(os.path.join(modelPath, "model.w"), "w")
    saver = tf.train.import_meta_graph(os.path.join(modelPath, "model.meta"))
...
if __name__ == "__main__":
    extract_parameter("/Users/mingxw/Projects/HZNLP/model/ner_compress")